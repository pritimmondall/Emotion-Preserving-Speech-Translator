...
const steps = [
  ...
  },
  {
    ...
    tech: "faster-whisper, Whisper tiny model",
  },
  {
    icon: Brain,
    title: "Emotion Detection",
    description: "Real-time emotion analysis from audio using wav2vec2 fine-tuned for speech emotion recognition",
    tech: "transformers, wav2vec2-lg-xlsr-en-speech-emotion-recognition",
  },
  {
    icon: Languages,
    title: "Neural Translation",
    description: "Context-aware translation using Helsinki-NLP models with emotion-preserving post-processing",
    tech: "Helsinki-NLP/opus-mt, transformers",
  },
  {
    icon: Sparkles,
    title: "Emotion Preservation",
    description: "Punctuation, emphasis, and tone markers adjusted based on detected emotion and intensity",
    tech: "Custom prosody adaptation",
  },
  {
    icon: Volume2,
    title: "Prosody Control",
    description: "User-adjustable pitch, tone, and speed controls for fine-tuning output voice synthesis",
    tech: "Prosody parameters",
  },
];
